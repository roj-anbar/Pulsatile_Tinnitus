...
OUTPUT_PNG="$BASE_DIR/step2_PostProcess/Spectrogram_wallpressure/${CASE}_spec_regions2.png"     # Path to output PNG
CONFIG="$BASE_DIR/step2_PostProcess/configs/${CASE}_viz_config.yaml"                # Path to viz config YAML
...
#     --path_output_png     "/Users/rojin/Dropbox/My_Projects/Study1_PTRamp/cases/PTSeg028_base_0p64/step2_PostProcess/Visualization/PTSeg028_base_0p64_spec_regions_top.png"
