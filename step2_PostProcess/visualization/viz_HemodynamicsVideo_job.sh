...
OUTPUT="$BASE_DIR/step2_PostProcess/Hemodynamics/Video"
...
#     --output_folder     "$SCRATCH/My_Projects/Study1_PTRamp/cases/PTSeg028_base_0p64/step2_PostProcess/Hemodynamics/Video" \
