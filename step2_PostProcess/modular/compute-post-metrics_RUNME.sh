...
OUTPUT="$BASE_DIR/post-process/SPI_pressure/cy6_Q=2t_test"
SCRIPT="$SLURM_SUBMIT_DIR/compute-post-metrics.py"  # ensure to submit from script dir
...
#python compute-post-metrics.py \
...
#    --output_folder "$SCRATCH/PT/PT_Ramp/PT_cases/PTSeg028_base_0p64/post-process/SPI_pressure/cy6_Q=2t_test" \
#    --n_process     192 \
#    --window_size   4000 \
#    --window_overlap 0.75
